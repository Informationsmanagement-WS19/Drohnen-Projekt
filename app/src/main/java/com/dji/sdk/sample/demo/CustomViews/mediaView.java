...
public class mediaView extends Activity implements View.OnClickListener {

    private static final String TAG = mediaView.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.media_overview);
        initUI();
    }
    ...
    protected void onDestroy() {
        ...
        DJISampleApplication.getProductInstance().getCamera().setMode(SettingsDefinitions.CameraMode.SHOOT_PHOTO, new CommonCallbacks.CompletionCallback() {
            @Override
    ...
    void initUI() {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(mediaView.this, RecyclerView.VERTICAL,false);
        ...
        //Init Loading Dialog
        mLoadingDialog = new ProgressDialog(mediaView.this);
        mLoadingDialog.setMessage("Please wait");
        mLoadingDialog.setCanceledOnTouchOutside(false);
        mLoadingDialog.setCancelable(false);

        //Init Download Dialog
        mDownloadDialog = new ProgressDialog(mediaView.this);
    ...
    private void setResultToToast(final String result) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(mediaView.this, result, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void setResultToText(final String string) {
        ...
        mediaView.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    private void initMediaManager() {
        if (DJISampleApplication.getProductInstance() == null) {
            ...
            if (null != DJISampleApplication.getProductInstance().getCamera() && DJISampleApplication.getProductInstance().getCamera().isMediaDownloadModeSupported()) {
